...
fn main() {
    ...
    println!("starting ABC algorithm");
    ...
    let mut current_positions_x: Vec<f64> = Vec::new();
    let mut current_positions_y: Vec<f64> = Vec::new();
    let mut current_velocities_x: Vec<f64> = Vec::new();
    let mut current_velocities_y: Vec<f64> = Vec::new();
