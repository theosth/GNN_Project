...
from simulations.elastic_collisions import Body, Variables, ElasticCollisionSimulation, HiddenVariables
import torch
...
def model(p):
    starting_velocities = torch.tensor([[p["X0"],  p["Y0"]], [p["X1"],  p["Y1"]]])
